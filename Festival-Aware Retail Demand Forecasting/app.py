    ...
    if predict_btn:
        ...
        with g2:
            ...
            st.dataframe(
                ...
                .format({"Actual (₹)": "₹{:,.0f}", "Potential (₹)": "₹{:,.0f}"}),
                use_container_width=True,
                hide_index=True,
                height=320
            )
            
            st.caption("🔍 **Business Reality Check:** 'Actual (₹)' shows revenue you will earn with current stock. 'Potential (₹)' shows what you are missing by not restocking.")
